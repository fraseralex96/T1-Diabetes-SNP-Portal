...
#######GO TERMS FILE########
#import GO data
gtDF = pd.read_table(r'C:/Users/frase/OneDrive/Documents/MSc Bioinformatics/Group Project/Data/GO terms.tsv')

#replace blanks with N/A
gtDF = gtDF.fillna('N/A')

#save to a new file
gtDF.to_csv(r'C:/Users/frase/OneDrive/Documents/MSc Bioinformatics/Group Project/Data/gt.tsv', sep="\t")

########RAF FILE#########
#import data
rafDF = pd.read_csv(r'C:/Users/frase/OneDrive/Documents/MSc Bioinformatics/Group Project/Data/RAF-complete.csv')
