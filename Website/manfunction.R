...
man_function <- function(snplist) {
  ...
  man_data <- read.csv("./data/Type 1 GWAS.csv", fileEncoding="UTF-8-BOM")
  ...
  manhattan_plot = manhattanly(data_new, snp = "SNP", gene = "Mapped gene(s)", highlight = snplist, labelChr=c(1:22, "X"), suggestiveline = FALSE, genomewideline = FALSE, highlight_color = "#18E0FF")
